...
public abstract class BodyBuilder {
    public abstract Message createMessage(Object[] methodArgs);

    public static final BodyBuilder EMPTY_SOAP11 = new Empty(SOAPVersion.SOAP_11);
    public static final BodyBuilder EMPTY_SOAP12 = new Empty(SOAPVersion.SOAP_12);
    ...
    private static final class Empty extends BodyBuilder {
        ...
        public Message createMessage(Object[] methodArgs) {
     ...
     * from JAXB objects.
     */
    public static abstract class JAXB extends BodyBuilder {
        /**
        ...
        public final Message createMessage(Object[] methodArgs) {
    ...
    public final static class Bare extends JAXB {
         ...
         */
        public Bare(ParameterImpl p, SOAPVersion soapVersion, ValueGetter getter) {
     ...
     */
   public abstract static class Wrapped extends JAXB {
    ...
    public final static class DocLit extends Wrapped {
         ...
         */
        public DocLit(WrapperParameter wp, SOAPVersion soapVersion, ValueGetterFactory getter) {
    ...
    public final static class RpcLit extends Wrapped {
         ...
         * Creates a {@link BodyBuilder} from a {@link WrapperParameter}.
         */
        public RpcLit(WrapperParameter wp, SOAPVersion soapVersion, ValueGetterFactory getter) {
            super(wp, soapVersion, getter);
         ...
         */
       public CompositeStructure build(Object[] methodArgs) {
